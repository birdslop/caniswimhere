...
# ── NSOH – National Storm Overflow Hub feature service endpoints ──
# Near-real-time discharge data from water companies across the UK.
# Each endpoint is an ArcGIS FeatureServer supporting spatial queries.
# Tuples: (company_name, url, field_map | None)
# field_map overrides the default English NSOH field names.
_NSOH_DEFAULT_FIELDS = {
